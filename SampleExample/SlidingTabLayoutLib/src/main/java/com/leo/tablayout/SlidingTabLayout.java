...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.TabView, defStyle, 0);
    ...
    /**
     * Sets the colors to be used for indicating the selectedWeek tab. These colors are treated as a
     ...
     * that the layout can update it's scroll id correctly.
     *
    ...
    public void onResetColor() {
        ...
        for (int i = 0; i < mTabStrip.getChildCount(); i++) {
            mTabStrip.getChildAt(i).setSelected(mViewPager.getCurrentItem() == i);
        }
        textViewList.get(mViewPager.getCurrentItem()).setSelected(true);
    }
            ...
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                if (v == mTabStrip.getChildAt(i)) {
                    ...
                    if (tabSelectedListener != null) {
                        tabSelectedListener.onCurrentItem(i);
                    }
                    return;
                }
            }
